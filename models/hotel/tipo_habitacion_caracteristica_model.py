...
class TipoHabitacionCaracteristica(Base):
    """
    Modelo SQLAlchemy para la tabla HOTEL.Tb_tipoHabitacionCaracteristicas
    ...
    tipo_habitacion_id = Column(
        Integer, 
        ForeignKey('HOTEL.Tb_tipoHabitacion.id_tipoHabitacion'), 
        primary_key=True,
        nullable=False
    )
    caracteristica_id = Column(
        Integer, 
        ForeignKey('HOTEL.Tb_caracteristicas.id_caracteristica'), 
        primary_key=True,
        nullable=False
    )
