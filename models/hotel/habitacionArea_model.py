...
class HabitacionArea(Base):
    ...
    incidencias = relationship("Incidencia", back_populates="habitacion_area", cascade="all, delete-orphan")
    limpiezas = relationship("Limpieza", back_populates="habitacion_area")
    def __repr__(self):
